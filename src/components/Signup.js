...
const Signup = (props) => {
    ...
    // Dynamic Host Selection: Production env variable or fallback to Localhost
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (json.success) {
                ...
                props.showAlert(json.error || json.message || "User already exists", "danger");
            }
        } catch (error) {
    ...
    return (
        <div className="container mt-3">
            <h2 className="my-3">Create an account to use DevNote</h2>
